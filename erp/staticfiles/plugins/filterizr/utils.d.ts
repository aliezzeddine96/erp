...
/**
 * Returns an object with self/key pairs of all data
 ...
 */
declare const checkOptionForErrors: (name: string, self: string | number | boolean | object | Function | any[], type?: string, allowed?: RegExp | any[], furtherHelpLink?: string) => void;
